    ...
    <div class="about-us-container h-100">
        <div class="row h-100 align-items-center">
          <div class="col-12 text-center">
            <h3 class="about-us-title">Triple Play Services</h3>
            <hr>
          </div>
        </div>
      </div>
            ...
            <div class="col-lg-7 col-md-6 col-sm-12" data-aos="zoom-out-left" data-aos-duration="5000">
                <div class="row about-us-content">
                    ...
                    <div >
                        <div class="row about-us-content">
                            <ul class="ml-3">
                                <li><p> Internet Services, provide internet broadband & dedicated according to customer request</p></li>  
                                <li><p> IPTV/MATV, provide TV service that displays the latest entertainment programs with the best resolution quality </p></li>  
                                <li><p> Telephony, IP-based Telephone Service, which is continuously developed and managed so that it remains relevant and adaptive to today's business telecommunications needs.</p></li>  
                            </ul>
                        </div>
                    </div>
                </div>

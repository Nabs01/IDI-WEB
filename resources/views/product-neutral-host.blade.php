    ...
    <div class="about-us-container h-100">
        <div class="row h-100 align-items-center">
          <div class="col-12 text-center">
            <h3 class="about-us-title">Neutral Host Infrastructure</h3>
            <hr>
          </div>
        </div>
      </div>
                ...
                <div class="row about-us-content">
                    ...
                    <div >
                        <div class="row about-us-content">
                            ...
                            <ul class="ml-3">
                                <li><p> Operator Independency, can be used for various services (Internet, IPTV, Telephony)</p></li>  
                                <li><p> Flexible, in dealing with service changes, service additions and service improvements from each operator</p></li>  
                                <li><p> Neat and clean, not overlapping and simple</p></li>  
                                <li><p> Sophisticated, accommodate future technological developments </p></li>    
                            </ul>
                        </div>
                    </div>
                </div>

                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="why-us-image">
                            <img class="img-fluid" src="{{ asset('/images/vector/performance.svg')}}" alt="Quality and Performance">
                        </div>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="why-us-image">
                            <img class=" img-fluid" src="{{ asset('/images/vector/people.svg')}}" alt="Expert and Experience Team">
                        </div>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="why-us-image">
                            <img class="img-fluid" src="{{ asset('/images/vector/cs.svg')}}" alt="Online Costumer Services">
                        </div>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="why-us-image">
                            <img class=" img-fluid" src="{{ asset('/images/vector/speed.svg')}}" alt="Faster Connectivity">
                        </div>
